...
const pageKeys = ['accueil','production','comparatif','climat','commerce','securite','foncier','finance','technologie','social','durabilite','indices','analyses'] as const
const pageComponents: Record<string, React.FC> = {
  ...
  technologie: Technologie, social: Social, durabilite: Durabilite, indices: Indices, analyses: Analyses,
}
